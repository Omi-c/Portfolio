...
export function Contact() {
    ...
    }, [contactContainerRef, observingHandling, activateParaph, contactContentTITLEClassName]);

    return (
        <footer ref={contactContainerRef} className="contact-content">
            <h2 className="contact-content__title title">
                Contact <span className="contact-content__title__me title__selected-text ">Me</span>
            </h2>
